...
{{--                {!! Form::open(['method'=>'POST', 'action'=>'PropertyController@store','id'=>'form-submit', 'role'=>'form','files'=>true]) !!}--}}
                {!! Form::model($unit,['method'=>'PATCH','action'=>['PropertyController@update',$unit->id], 'files'=>true]) !!}
...
{{--                                                        </select>--}}
                                                            ...
                                                            {!! Form::select('Cities',$cities,null,['class'=>'form-control', 'id'=>'cities']) !!}
...
{{--                                                                </select>--}}
                                                                    ...
                                                                    {!! Form::select('property_type',$property_type,null,['class'=>'form-control', 'id'=>'property_type']) !!}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                    ...
                                                                    {!! Form::text('beds',old('beds'),['class'=>'form-control', 'id'=>'beds', 'pattern'=>'\d*', 'required']) !!}
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                    ...
                                                                    {!! Form::text('baths',old('baths'),['class'=>'form-control', 'id'=>'baths','pattern'=>'\d*', 'required']) !!}
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <div class="form-group">
                                                                {!! Form::label('area','Area') !!}
                                                                        ...
                                                                        {!! Form::text('area',old('area'),['class'=>'form-control', 'id'=>'area','pattern'=>'\d*']) !!}
...
{{--                                                                <input type="text" class="form-control" id="submit-garages" name="garages" pattern="\d*" value="{{old('garages')}}">--}}
                                                                    {!! Form::label('garages','No. of Garage') !!}
                                                                    {!! Form::text('garages',old('garages'),['class'=>'form-control', 'id'=>'garages','pattern'=>'\d*']) !!}

                                                                <small class="error">{{$errors->first('garages')}}</small>
                                                            </div><!-- /.form-group -->
                                                        </div><!-- /.col-md-6 -->
                                                    </div><!-- /.row -->
                                                    <div class="checkbox">
                                                        <label>
{{--                                                            {{$unit->israting}}--}}
{{--                                                            <input type="checkbox" name="israting">Allow user rating <i class="fa fa-question-circle tool-tip"  data-toggle="tooltip" data-placement="right" title="Users can give you a stars rating which is displayed in property detail"></i>--}}
                                                            {!! Form::checkbox('israting',null,($unit->israting == 1) ? true : false) !!} Allow user rating <i class="fa fa-question-circle tool-tip"  data-toggle="tooltip" data-placement="right" title="Users can give you a stars rating which is displayed in property detail"></i>
{{----}}
                                                        </label>
                                                    </div>
                                                </section><!-- /#summary -->
...
{{--                                                                <input type="text" class="form-control" id="latitude" value="{{old('map_lat')}}" name="map_lat" readonly>--}}
                                                                    ...
                                                                    {!! Form::text('map_lat',old('map_lat'),['class'=>'form-control', 'id'=>'map_lat','readonly']) !!}
...
{{--                                                                <input type="text" class="form-control" id="longitude" name="map_lon" value="{{old('map_lon')}}" readonly>--}}
                                                                {!! Form::text('map_lon',old('map_lon'),['class'=>'form-control', 'id'=>'map_lon','readonly']) !!}
                                                            </div><!-- /.form-group -->
                                                        </div>
                                                    </div>
                                        ...
                                        <ul class="submit-features" id="ul_features">
                                            @foreach($property_features as $key=>$feature)
                                                <li>
                                                    <div class="checkbox">
                                                        <label>
{{--                                                            <input type="checkbox" name="property_features[]" value="{{$key}}">{{$feature}}--}}
                                                            {!! Form::checkbox('property_features[]', $key, in_array($key,$property_selected_features) ? true : false) !!}{{$feature}}
                                                        </label>
                                                    </div>
                                                </li>
                                            @endforeach
                ...
                <div class="row">
                    <div class="block">
                        <div class="col-md-9 col-sm-9">
                            <div class="center">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-default large">Update</button>
                                </div><!-- /.form-group -->
...
{{--                            created_by:"{{Auth::user()->id}}",--}}
                        ...
                        success: function(result) {
                            ...
                            if(!result.errors)
                            {
                                ...
                                alert('the has an error');
                            }
                        },
                        error: function(jqXHR, textStatus, errorThrown) {
                            console.log(errorThrown);
{{--                            alert("{{url('/addFeatures')}}");--}}
