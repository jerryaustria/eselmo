...
//  Show counter after appear
    ...
    agentState();
    //jerry austria nothing change here
...
function agentState(){
    ...
    // if ($agentSwitch.data('agent-state') == 'is-agent') {  jerry austria
    if ($agentSwitch.data('agent-state') == 'is-agent' && $agentSwitch.data('agent-value') == 'Agent') {
        // alert("enable");
        ...
        $agentSwitch.data('agent-value', 'Agent');
