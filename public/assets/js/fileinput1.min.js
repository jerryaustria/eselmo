...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, v, h, w, b, _, C, y, x, T, F, I, P, E, k, S, A, D, z, M, U, j,
                $, R, O, B, L, Z, N = this;
            ...
            var n, o, l, s, d, c, u, p, f, g, m, v, h, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                ...
                T = w.ajaxOperations.uploadThumb, F = b.getFile(a), I = {id: y, index: i, fileId: a},
            ...
            i._initZoomButton(), a.find(n).each(function () {
                ...
                if (!t.isEmpty(p) && void 0 !== f) {
                    ...
                    var m, v, h, w, b, _ = u.closest(t.FRAMES), C = i.previewCache.data, y = _.attr("data-fileindex");
            ...
            var v, h, w, b = this, _ = b.slug(r), C = "", y = "",
                ...
                F = _, I = "type-default", P = u || b._renderFileFooter(i, _, d, "auto", s), E = b.preferIconicPreview,
            ...
            var o, l, s, d, c, u, p, f, g, m, v = this, h = e(a.img)[0], w = h.naturalWidth, b = h.naturalHeight, _ = 1,
                ...
                F = v.imageCanvasContext, I = a.typ, P = a.pid, E = a.ind, k = a.thumb, S = a.exifObj;
            if (c = function (e, t, i) {
            ...
            var a, r = this, n = r.$element, o = r.reader, l = r.$previewContainer, s = r.$previewStatus,
                ...
                h = t.isEmpty(v) ? "" : v.join(", "), w = function (t, n, o, l, s, d) {
                    var c, u = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {id: o, index: l, fileId: s}),
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                var _, C = r.$errorContainer, y = r.fileManager;
                ...
                r.lock(!0);
                var x, T, F, I, P, E, k, S, A, D, z, M, U, j, $ = i[b], R = u + "-" + r._getFileId($), O = f.text,
                    B = f.image, L = f.html, Z = r._getFileName($, ""), N = ($ && $.size || 0) / 1e3, H = "",
                    W = t.createObjectURL($), q = 0, V = "", G = 0, K = function () {
                        var e = c.setTokens({index: b + 1, files: p, percent: 50, name: Z});
                        setTimeout(function () {
                            s.html(e), r._updateFileDetails(p), a(b + 1)
                        }, r.processDelay), r._raise("fileloaded", [$, R, b, o]) && r.isAjaxUpload && y.add($)
                    };
                if ($) {
                    if (S = y.getId($), m > 0) for (T = 0; m > T; T++) E = g[T], k = r.msgFileTypes[E] || E, V += 0 === T ? k : ", " + k;
                    ...
                    z = O($.type, Z), M = L($.type, Z), U = B($.type, Z), s.html(d.replace("{index}", b + 1).replace("{files}", p)), l.addClass("file-thumb-loading"), o.onerror = function (e) {
                        ...
                        if (n = {name: Z, type: $.type}, e.each(f, function (e, t) {
                        ...
                        if (e.lengthComputable) {
                            ...
                            F = c.setTokens({index: b + 1, files: p, percent: i, name: Z}), setTimeout(function () {
                                s.html(F)
                            }, r.processDelay)
                        }
